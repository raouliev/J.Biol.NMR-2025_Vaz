...
str_dir = "../structures/240922_anneal_asr_minPRE_round1v2/"
...
protocol.loadPDB("../pdb/240922_anneal_asr_minPRE_10lowavg.pdb",deleteUnknownAtoms=True)
...
#all distance restraints introduced here; h-bonds, PRE's, disabmiguated restraints
for (name,scale,file) in [('ret_longrange_unambig',10,"../restraints/ret_longrate_unambig.tbl"),
                          ('ret_med-to-seq_unambig',10,"../restraints/ret_med-to-seq_unambig.tbl"),
                          ('round1',10,"../restraints/minimum pre long range restraints round 1.tbl"),
...
from ivm import IVM
dyn = IVM()
#following fixes TALOS+ predicted a-helical segments in ASR, after formation of helical segments. 
#dyn.group("resid 7:25")
#dyn.group("resid 33:56")
#dyn.group("resid 70:91")
#dyn.group("resid 102:120")
#dyn.group("resid 126:147")
#dyn.group("resid 152:156")
#dyn.group("resid 163:183")
#dyn.group("resid 194:221")
...
minc = IVM()
#see above
#minc.group("resid 7:25")
#minc.group("resid 33:56")
#minc.group("resid 70:91")
#minc.group("resid 102:120")
#minc.group("resid 126:147")
#minc.group("resid 152:156")
#minc.group("resid 163:183")
#minc.group("resid 194:221")
minc.group(ret_sel)

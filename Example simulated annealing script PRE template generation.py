...
str_dir = "../structures/PRE_template_generation/"
...
protocol.loadPDB("../pdb/ahelical_segments.pdb",deleteUnknownAtoms=True)
...
for (name,scale,file) in [('PREs',10,"../restraints/PREs.tbl"),

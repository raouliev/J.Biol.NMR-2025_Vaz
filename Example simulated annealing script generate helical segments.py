...
str_dir = "../structures/Generate_a-helices/"
...
protocol.loadPDB("../pdb/extended.pdb",deleteUnknownAtoms=True)
...
for (name,scale,file) in [('hbond',10,"../restraints/hbond_regular.tbl")
                          ]:
